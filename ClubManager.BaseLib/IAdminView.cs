...
namespace ClubManager.BaseLib
{
    ...
    {
        bool ShowViewModaless(IMainController inController, Admin inAdmin, List<Player> players, List<Trainer> trainers, List<Team> teams, IList<Transaction> transactions);
